    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectPermissions", x => x.ObjectPermissionID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObjectPermissions_Users_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QrCodeSessionID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QrCodeSessions", x => x.QrCodeSessionID);
                    table.ForeignKey(
                        name: "FK_QrCodeSessions_Users_UserID",
                        column: x => x.UserID,
                        principalTable: "Users",
                        principalColumn: "UserID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjectPermissions_UserID",
                table: "ObjectPermissions",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_OtpRecords_OtpCode",
                table: "OtpRecords",
                column: "OtpCode",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QrCodeSessions_Code",
                table: "QrCodeSessions",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QrCodeSessions_UserID",
                table: "QrCodeSessions",
                column: "UserID");
